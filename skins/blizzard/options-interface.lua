pfUI:RegisterSkin("Options - Interface", "tbc", function ()
  ...
  CreateBackdrop(InterfaceOptionsFrame, nil, nil, .85)
  ...
  CreateBackdrop(InterfaceOptionsFrameCategories, nil, true, .85)
  StripTextures(InterfaceOptionsFrameAddOns)
  CreateBackdrop(InterfaceOptionsFrameAddOns, nil, true, .85)
  CreateBackdrop(InterfaceOptionsFramePanelContainer, nil, true, .85)
...
pfUI:RegisterSkin("Options - Interface", "vanilla", function ()
  ...
  CreateBackdrop(UIOptionsFrame, nil, nil, .85)
  ...
  CreateBackdrop(BasicOptionsGeneral, nil, true, .85)
  CreateBackdrop(BasicOptionsDisplay, nil, true, .85)
  CreateBackdrop(BasicOptionsCamera, nil, true, .85)
  CreateBackdrop(BasicOptionsHelp, nil, true, .85)
  CreateBackdrop(AdvancedOptionsActionBars, nil, true, .85)
  CreateBackdrop(AdvancedOptionsChat, nil, true, .85)
  CreateBackdrop(AdvancedOptionsRaid, nil, true, .85)
  CreateBackdrop(AdvancedOptionsCombatText, nil, true, .85)
